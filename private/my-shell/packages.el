...
(defun my-shell/pre-init-company ()
  ;; support in eshell
...
(defun my-shell/init-esh-help ()
  (use-package esh-help
    :defer t
    :init (add-hook 'eshell-mode-hook 'eldoc-mode)
    :config (setup-esh-help-eldoc)))

(defun my-shell/init-eat ()
  (use-package eat
    :ensure t
    :config
    (eat-eshell-mode)
...
(defun my-shell/init-eshell-syntax-highlighting ()
...
(defun my-shell/pre-init-evil-collection ()
  (add-to-list 'spacemacs-evil-collection-allowed-list 'vterm))

(defun my-shell/init-eshell-prompt-extras ()
...
(defun my-shell/pre-init-magit ()
  (spacemacs|use-package-add-hook magit
    :post-init
    (defalias 's 'magit-status)))

(defun my-shell/init-multi-term ()
...
;; (defun my-shell/init-xterm-color ()
...
(defun my-shell/init-terminal-here ()
...
(defun my-shell/post-init-vi-tilde-fringe ()
...
(defun my-shell/post-init-window-purpose ()
